% he-dyndns-update(SECTION) | User Commands
%
% "March 17 2025"
...
he-dyndns-update - program to do something

# SYNOPSIS

**he-dyndns-update** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**he-dyndns-update** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **he-dyndns-update** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**he-dyndns-update** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    he-dyndns-update. See **foo.conf**(5) for further details.
...
**he-dyndns-update** provides some return codes, that can be used in scripts:
